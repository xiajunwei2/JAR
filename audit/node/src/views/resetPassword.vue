        ...
        <el-form :model="logins" :rules="rules" ref="ruleForm" label-width="0" class="demo-ruleForm">
          <el-form-item prop="loginName">
            <div class="item-input">
              <el-input placeholder="请输入账号" clearable v-model="logins.loginName"></el-input>
            </div>
          </el-form-item>
          <el-form-item prop="yzm">
            <div class="item-input item-yzm">
              <el-input class="item-input-yzm" clearable type="text" placeholder="请输入验证码"></el-input>
              <img src="../assets/yzm.png" class="item-input-yzm-img" @click="submitForm('ruleForm')" alt />
            </div>
          </el-form-item>
          <el-form-item prop="password">
            <div class="item-input">
              <el-input type="password" clearable placeholder="请输入密码" v-model="logins.password"></el-input>
            </div>
          </el-form-item>
          <el-form-item>
