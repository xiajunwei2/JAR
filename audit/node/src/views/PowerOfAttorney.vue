<template>
  <div class="review">
    <div class="review_left">
      <div class="left_head">
        <div>注册人姓名<span>刘能</span></div>
        <div class="head_card">企业名称<span> 河北望江盛达钢结构工程有限公司</span></div>
      </div>
      <div class="left_body">
    ...
    <div class="review_right">
      <div class="right_head">
        ...
        <div class="right_head_roules">
          ...
          <div>2. 公章是否完整； </div>
          <div>3. 系统中企业名称与注册人姓名是否与图中一致.</div>
        </div>
      </div>
      <div class="right_body">
        ...
        <div class="right_body_choce" :class="currentIndex==2?'actives':''" @click="choceResult(2)">
          <div class="choce_icon iconfont " :class="currentIndex==2?'icon-icon active':''"></div>
          <div class="choce_text">不通过</div>
        </div>
        <div class="right_body_nopass" :class="flag==true?'disp_block':''">
