  ...
  <div class='user-center-box jq-maxwidth'>
    ...
    <div class="user-center-left">
      <ul class='user-center-list'>
        ...
        <li class="list-item" :class='{active:it.routername==$route.meta.subname}' v-for='it in usercenterLists'
            :key='it.name' @click='jumpTo(it.routername)'>
          <span class="item-text">{{ it.name }}</span>
        </li>
      </ul>
    </div>
    <div class='user-center-right'
         :style="{background:$route.meta.subname == 'my-loan' || $route.meta.subname == 'my-companys' ? 'none' : ''}">
