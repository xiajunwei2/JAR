<template>
  <div class="index">
    <div class="account_head">
      <div class="head_search">
        ...
        <div style="margin:0 10px;">
          ...
          <el-input-number v-model="loanMoneyDown" label="最低金额" :min="0"></el-input-number> ---
          <el-input-number v-model="loanMoneyUp" label="最高金额" :min="0"></el-input-number>/万元
        </div>
      </div>
      <div class="head_time">
    ...
    <div style="background:#fff;padding:0 30px;" v-loading="loading">
      ...
      <vxe-table-column field="companyName" title="企业名称" show-overflow="tooltip" align="left"></vxe-table-column>
...
export default {
  ...
  created() {
    let vm = this;
    this.getProdList();
    vm.userId = vm.$store.state.userInfor ? vm.$store.state.userInfor.userId:'';
  },
  methods: {
    getTime() {
